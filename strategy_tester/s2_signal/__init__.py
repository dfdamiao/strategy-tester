...
# --- KILLED_ARCHETYPE re-probe signals (quantocracy kill pile, 2026-06-22) ---
from strategy_tester.s2_signal import double_bottom  # noqa: F401
from strategy_tester.s2_signal import consec_down  # noqa: F401
from strategy_tester.s2_signal import nday_low  # noqa: F401
